...
Given("I select the customer name {string}", function (customer_name) {
...
When("I enter the amount {string} to deposit and click on deposit button", function(deposit_amount)  {
